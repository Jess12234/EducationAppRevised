...
public class AttendanceScreen extends ListActivity  implements android.view.View.OnClickListener{
    ...
    public void onClick(View view) {
        if (view== findViewById(R.id.btnAdd)){
            ...
            if(studentList.size()!=0) {
                ...
                ListAdapter adapter = new SimpleAdapter( AttendanceScreen.this,studentList, R.layout.view_student_entry, new String[] { "id","name"}, new int[] {R.id.student_Id, R.id.student_name});
